package com.app.tnbbs.view.user.informasi.adapter
...
class WisataAdapterUser(
    private val context: Context,
    private val dataList: MutableList<Wisata>
) : RecyclerView.Adapter<WisataAdapterUser.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.ivWisata.setOnClickListener{
            ...
            Navigation.findNavController(it).navigate(com.app.tnbbs.R.id.action_informasiWisataFragment_to_detailInformasiWisataFragment, bundle)
        }
    }
