package com.app.tnbbs.view.user.histori.adapter
...
class TiketAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.cardView.setOnClickListener{
            ...
            Navigation.findNavController(it).navigate(com.app.tnbbs.R.id.action_homeTiketFragment_to_detailTiketFragment, bundle)
        }
    }
